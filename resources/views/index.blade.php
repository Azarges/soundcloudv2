...
@section('content')
    <h2 class="h2_page_index">Écoutez gratuitement les dernières tendances de la communauté SoundCloud</h2>
    ...
    @auth()
        <h2 class="h2_page_index">Merci de nous avoir écouté !<br>Sauvegardez des titres, suivez des artistes et créez des playlists, tout cela gratuitement.</h2>
    @endauth

    @guest()
    <h2 class="h2_page_index">Merci de nous avoir écouté ! Inscrivez-vous dès maintenant.<br>
